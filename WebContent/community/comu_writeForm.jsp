...
<body>
	...
	<div class="container m-t-150">
		...
		<form action="comu_writePro.jsp"  method="post" enctype="multipart/form-data" name="fr">
		
			<input type="hidden" name="bg_id" class="form-control" id="inputAuthor" value="1">
			
			<div class="form-group row">
				<label for="inputTitle" class="col-sm-2 col-form-label"><strong>말머리</strong></label>
	            <select name="commu_category" class="form-control col-sm-2 m-l-13">
