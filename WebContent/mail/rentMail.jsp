	...
	<div class="limiter">
		<div class="container-login100" >
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="post" action="rentMailPro.jsp" id="fr">
					<span class="login100-form-title p-b-49">
						<a href="../index.html"><img class="img-logo" src="../images/login_logo.png"/></a>
					</span>
					<input type="hidden" name="content" value="<%=content%>"> <label style="font-size: 20px; color:#585858;"> 자전거대여소 메일인증
					</label><hr><br>
