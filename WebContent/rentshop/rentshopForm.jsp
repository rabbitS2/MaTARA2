...
//            	   alert(JSON.stringify(result));
		...
		<div class="container m-t-150">
				...
				<form class="login100-form validate-form" action="rentshopPro.jsp" method="post" id="rentfr" class="p-5 bg-white">
					<h3 class="m-b-20">  [자전거대여소 등록]</h3>
					<hr class="m-b-30" style="border:#32dbc6 2px solid">
    				
					<input type="hidden" name="user_id" value="<%=id %>">

					<div class="wrap-input100 validate-input m-b-23">
						<span class="label-input100">대여소 이름</span>
						<span class="chkMsg_name"></span>  
						<input class="form-control" id="rentinfo_name" type="text" name="rentshop_info_name" placeholder="대여소 이름을 입력해주세요">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-23">
						<span class="label-input100">대여소 연락처</span>
						<span class="chkMsg_tel"></span>  
						<input class="form-control" id="rentinfo_tel" type="text" name="rentshop_info_tel" placeholder="연락처를 입력해주세요">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					<br>
					<div class="wrap-input100 validate-input m-b-23">
						<span class="label-input100">대여소 위치</span>
						<span class="chkMsg_addr"></span><br>  
						<input class="btn btn-primary text-white" type="button" onclick="execDaumPostcode()" value="우편주소검색"><br><br>
						<input class="form-control" id="rentinfo_addr1" name="rentshop_info_addr1" type="text" placeholder="우편주소를 검색해주세요" readonly ><br>
   						<input class="form-control" id="rentinfo_addr2" name="rentshop_info_addr2" type="text" placeholder="우편주소를 검색해주세요" readonly  ><br>
   						<input class="form-control" id="rentinfo_addr3" name="rentshop_info_addr3" type="text" placeholder="상세주소를 입력해주세요" ><br>
					</div>
					
					<div class="wrap-input100 validate-input m-b-23">
						<span class="label-input100">보유 자전거 총대수</span>
						<span class="chkMsg_total"></span>  
						<input class="form-control" id="rentinfo_total" type="text" name="rentshop_info_total" placeholder="보유 자전거 총대수">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-23">
						<span class="label-input100">성인용 자전거 대수</span>
						<span class="chkMsg_abike"></span>  
						<input class="form-control" id="rentinfo_abike" type="text" name="rentshop_info_abike" placeholder="성인용 자전거 대수">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-23">
						<span class="label-input100">어린이용 자전거 대수</span>
						<span class="chkMsg_kbike"></span>  
						<input class="form-control" id="rentinfo_kbike" type="text" name="rentshop_info_kbike" placeholder="어린이용 자전거 대수">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-23">
						<span class="label-input100">2인용 자전거</span>
						<span class="chkMsg_tbike"></span>  
						<input class="form-control" id="rentinfo_tbike" type="text" name="rentshop_info_tbike" placeholder="2인용 자전거 대수">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					
					<div class="info_title m-b-230">
					<button type="submit" class="btn btn-primary text-white" id="rent_submit">대여소 등록</button>
					</div>
